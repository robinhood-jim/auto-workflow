...
<div id="mainFrame" >
    <iframe id="container" style="overflow-y:auto;overflow-x:hidden!important;width:100%;height:100%" frameborder="no" src="pages/editor/workfloweditor.html" ></iframe>
</div>
...
<script type="text/javascript">
   ...
   tabbar.addTab("main", "流程设计器", "100px");
   tabbar.cells("main").setActive();
   tabbar.cells("main").attachURL(ctx+"component/mxGraph/grapheditor/index.jsp")
